...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, firstname="erty", middlename="rtyu", lastname="otyu", nickname="tyui", company="sdfg", title="asdf", address="dfgh", home="dfgh", mobile="ghjk", work="hjkl", fax="kl;h", email="zxcv", email2="vbnm", email3="vbnm", homepage="fghj", bday="20", bmonth="December", byear="1986", aday="10", amonth="May", ayear="2002")
