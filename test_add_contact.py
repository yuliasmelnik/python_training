...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, firstname="erty", middlename="rtyu", lastname="rtyu", nickname="tyui", company="sdfg", title="asdf", address="dfgh", home="dfgh", mobile="ghjk", work="hjkl", fax="kl;h", email="zxcv", email2="vbnm", email3="vbnm", homepage="fghj", bday="20", bmonth="December", byear="1985", aday="30", amonth="February", ayear="2001")
